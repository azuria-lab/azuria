...
import { Archive, MessageCircle, Plus, Search, Trash2, Users } from "lucide-react";
      ...
      <div className="p-4 border-b border-border">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {onCreateDirectChat && !showArchived && (
              <Button
                variant="outline"
                size="icon"
                className="h-8 w-8"
        ...
        {filteredChats.map((chat) => {
          ...
          return (
            <motion.div
              key={chat.id}
              className={cn(
                "flex items-center gap-3 p-3 cursor-pointer transition-colors border-b border-border/50 group",
                isSelected ? "bg-white dark:bg-gray-900" : "hover:bg-white dark:hover:bg-gray-900"
              )}
              whileTap={{ scale: 0.98 }}
            >
              <div 
              ...
              {onDeleteChat && (
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-7 w-7 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-transparent flex-shrink-0"
                  onClick={(e) => {
                    e.stopPropagation();
