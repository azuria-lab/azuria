...
export default function Dashboard() {
  ...
  const { stats, activities, tip, isLoading } = useDashboardStats();
                ...
                <CardContent>
                  <div className="space-y-4">
                    {displayActivities.slice(0, 5).map((activity) => {
                      const ActivityIcon = activity.icon === "CheckCircle2" ? CheckCircle2 : CheckCircle2;
                      return (
                      ...
                      <>
                        ...
                        {tip.actionUrl && tip.actionLabel && (
                          <Button
                            ...
                            onClick={() => navigate(tip.actionUrl!)}
                          >
                            {tip.actionLabel}
